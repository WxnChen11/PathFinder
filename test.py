...
ap_sf = shapefile.Reader("address_points/ADDRESS_POINT_WGS84.dbf")

ap_shapes = ap_sf.shapes()

cl_sf = shapefile.Reader("centreline/CENTRELINE_WGS84.dbf")

cl_shapes = cl_sf.shapes()

clint_sf = shapefile.Reader("centreline_intersection/CENTRELINE_INTERSECTION_WGS84.dbf")
